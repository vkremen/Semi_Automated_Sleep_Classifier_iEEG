...
%% if no features loaded in Matlab Workspace, load the data file, extract features, save features
if ~exist('feature_struct')
...
global   SelectedEpochs  time_axes Gold_Standard_Score subject_id hFig 
...
elseif strcmp(evt.Character, 'q')
    ...
    switch answer
        case 'Yes'
            ...
            return
        case 'No'
            close(hFig); % close the figure without saving
            return
        case 'Cancel'
            return
    end
